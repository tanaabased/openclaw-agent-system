...
- Added literal per-agent environment delivery and value-free `env` inspection with static OpenClaw delivery classification. [#2](https://github.com/tanaabased/openclaw-agent-system/pull/2)
...
- Added `session_start` and `before_tool_call` manifest loading with redacted lifecycle diagnostics. [#2](https://github.com/tanaabased/openclaw-agent-system/pull/2)

...
- Added manifest-declared agent model defaults and work tiers with configuration-only installation and separate ambient runtime, authentication, model, and effort readiness checks. [#85](https://github.com/tanaabased/openclaw-agent-system/issues/85)

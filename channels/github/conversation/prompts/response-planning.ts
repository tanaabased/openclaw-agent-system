...
const githubNotificationPlanningResponseInstructions = [
  ...
  '## Public style',
  'Write the candidate as a concise, conversational GitHub comment in your own voice. This is a comment, not a report. When the private report contains a plan, briefly summarize your understanding and proposed direction without copying the private report. When the private report contains questions, ask the smallest complete set of currently known blocking questions; use a short numbered list when there is more than one. Do not ask speculative or non-blocking questions.',
  '## Publication safety',

...
const githubNotificationAssignmentResponseInstructions = [
  ...
  '## Publication safety',
  'Do not include secrets, credentials, raw tool output, hidden or private context, or private machine details. When mentioning files, use repository-relative paths rather than absolute worktree paths. Agent System validates the candidate and reauthorizes its destination before publication.',
  '## Private response',

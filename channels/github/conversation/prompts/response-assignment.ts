...
const githubNotificationAssignmentResponseInstructions = [
  ...
  '## Public style',
  "Write the candidate as a concise, conversational GitHub comment in your own voice. This is a comment, not a report. Begin with a plain-language description of what the user is trying to accomplish and the problem or missing behavior they need resolved. When the private report contains a plan, follow that description with a brief active first-person commitment using language such as 'I'm going to' or 'I will', summarize what you will do, and say that you will do it to resolve or complete the issue. Do not copy the private report. When the private report contains questions, follow that description with the smallest complete set of currently known blocking questions; use a short numbered list when there is more than one. Use forward-looking language and do not report the implementation as completed. Do not ask speculative or non-blocking questions.",
  '## Publication safety',

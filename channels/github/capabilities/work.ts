...
import type {
  GitHubNotificationCapability,
  ResolvedGitHubNotificationCapability,
} from './types.ts';
...
const githubNotificationWorkCapability: GitHubNotificationCapability = {
  policy: {
    id: 'work',
...
export default githubNotificationWorkCapability;

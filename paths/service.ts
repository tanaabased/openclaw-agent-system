          ...
          ? [
              {
                ...
                message:
                  'The existing .codex/config.toml is user-managed; add allow_login_shell = false and the Agent System PATH entries manually as documented in MANIFEST.md#path.',
              },
            ]
          : [],
    };

...
- [GitHub notifications](./channels/github/README.md) — Turns approved issue assignments into managed worktrees and local sessions, then posts a short acknowledgment in the agent's voice.

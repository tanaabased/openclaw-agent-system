...
This scenario uses scenario-owned Data workspaces on a fresh runner. It verifies ordered dotenv precedence, dotenv-backed and host reference resolution, required-value enforcement, and value-free environment inspection without invoking a model.

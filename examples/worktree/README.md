...
This scenario verifies Agent System managed worktree preparation, discovery,
policy, health, and removal through the installed plugin and packaged `git`
shim. It does not start a Gateway, invoke a model, or load credentials.

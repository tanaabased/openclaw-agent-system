...
- Pass scenario-owned inputs to shared example helpers as command-line options. Reserve environment variables for the process or underlying runtime rather than using helper-specific environment aliases in scenario READMEs.
